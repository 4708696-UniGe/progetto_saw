...
<div class="row row-cols-1 row-cols-md-3 g-3 offset-1">
    <div class="col">
        <div class="card">
            <img src="../images/windows.png" class="card-img-top" alt="Avatar">
            <div class="card-body">
                <h5 class="card-title">Windows</h5>
                <p class="card-text">Viene fornito supporto per le versioni da windows 7 fino al recente Windows 10, da Windows Server 2012 per sistemi server. <br>
                    Hai una versione più datata? possiamo aiutarti ad eseguire un upgrade senza alcuna perdita di dati reinstallando tutto il parco software di cui hai bisogno.</p>
            </div>
        </div>
    </div>
    ...
    <div class="col">
        <div class="card">
            ...
            <div class="card-body">
                <h5 class="card-title">Android AOSP</h5>
                <p class="card-text">Un mondo dalle infinite possibilità. Qualunque sia la tua ROM o il suo maintainer noi sapremo aiutarti.</p>
            </div>
        </div>
    </div>
