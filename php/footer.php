...
<a title="Home" href="home.php">
  <img id="logo" src="../images/logo.png" alt="Logo azienda"></a>
    ...
    <ul class="social_footer">
      ...
      <li><a href="under_construction.php"><i class="fab fa-linkedin-in" aria-hidden="true"></i></a></li>
      <li><a href="under_construction.php"><i class="fab fa-twitter" aria-hidden="true"></i></a></li>
	  <li><a href="under_construction.php"><i class="fab fa-youtube" aria-hidden="true"></i></a></li>
    </ul>
	...
	<ul id"footer">
	  ...
	  <li id="piva">p. iva: 62396741670</li>
	  <li id="nome_azienda">System Hospital S.r.l.</li>
	  <li id="copyright">@ copyright 2020 - 2021</li>
	</ul>
