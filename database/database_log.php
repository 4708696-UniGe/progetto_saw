<?php
	...
	if(isset($_POST['email']) && isset($_POST['pass'])) {
		...
		$sql="SELECT id, firstname, lastname, email, pass, phone, company_name, workstation_os, mobile_os, about, subscription FROM users WHERE email='$email'";
