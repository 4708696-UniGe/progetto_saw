...
session_start();
    ...
    /*
     * Admin (USER_TYPE = 1) --> visualizza solo le chat con gli utenti
     * Utente (USER_TYPE = 0) --> visualizza solo le chat con gli admin
     */
...
$result = $statement->fetchAll();
    ...
    foreach($result as $row)
    {
        ...
        //chiamata alla funzione feetch_user_last_activity (in database_chat.php) che ritorna l'ultima attivit� dell utente
